...
class TaskUpdatedDiscordNotificationTest {
    ...
    void shouldCreateTaskUpdatedNotificationWithTitleChangedEvent(EasyRandom easyRandom) {
        ...
        // Quando a tarefa é atualizada sem mudança de título, o campo "Título" deve ser exibido
        assertField(fields.get(4), "Status", task.getStatus().getDisplayName());
        assertField(fields.get(5), "Vinculado a", taskEvent.getAssignee().getNameWithEmail());
        assertField(fields.get(6), "Atualizada por", taskEvent.getTriggeredBy().getNameWithEmail());
    }
    ...
    void shouldCreateTaskUpdatedNotificationWithTaskReassignedEvent(EasyRandom easyRandom) {
        ...
        assertField(fields.get(3), "Status", task.getStatus().getDisplayName());
        assertField(fields.get(4), "De", assigneeBefore.getNameWithEmail());
        assertField(fields.get(5), "Para", assigneeAfter.getNameWithEmail());
        assertField(fields.get(6), "Atualizada por", taskEvent.getTriggeredBy().getNameWithEmail());
    }
