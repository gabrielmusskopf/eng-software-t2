...
public class ArchitectureTest {
    ...
    static final ArchRule application_should_not_depend_on_adapters = noClasses()
            ...
            .because(
                    "A aplicação (use cases/portas) deve ser agnóstica em relação a quem a chama ou onde os dados são persistidos.");
    ...
    static final ArchRule adapters_in_should_not_depend_on_adapters_out = noClasses()
            ...
            .because(
                    "Adaptadores de entrada devem usar as portas de entrada da aplicação, e não chamar repositórios/bancos de dados diretamente.");
    ...
    static final ArchRule layer_dependencies_are_respected = layeredArchitecture()
            ...
            .whereLayer(DOMAIN)
            .mayOnlyBeAccessedByLayers(PORT, ADAPTER_IN, ADAPTER_OUT, CONFIG)
            .whereLayer(PORT)
            .mayOnlyBeAccessedByLayers(DOMAIN, ADAPTER_IN, ADAPTER_OUT, CONFIG)
            .whereLayer(ADAPTER_IN)
            .mayNotBeAccessedByAnyLayer()
            .whereLayer(ADAPTER_OUT)
            .mayNotBeAccessedByAnyLayer();
}
